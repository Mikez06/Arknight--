...
namespace FairyGUI
{
    ...
    public class DragDropManager
    {
        ...
        private Action<GObject> DragEndEvent;
        ...
        public object Data => _sourceData;
        ...
        public void StartDrag(GObject source, string icon, object sourceData, int touchPointID = -1, Action<GObject> dragEndEvent = null)
        {
        ...
        private void __dragEnd(EventContext evt)
        {
            ...
            while (obj != null)
            {
                if (obj.hasEventListeners("onDrop"))
                {
                    ...
                    DragEndEvent?.Invoke(obj);
                    return;
                }
                obj = obj.parent;
            }
            DragEndEvent?.Invoke(null);
        }
    }
}