...
namespace BattleUI
{
    public partial class UI_Battle : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            m_normalGroup = (GGroup)GetChildAt(15);
            m_endClick = (GComponent)GetChildAt(16);
            m_endPic = (GLoader)GetChildAt(17);
            m_endGroup = (GGroup)GetChildAt(25);
            m_GiveUpBack = (GGraph)GetChildAt(26);
            m_CancelGiveUp = (GComponent)GetChildAt(29);
            m_GiveUp = (GComponent)GetChildAt(30);
            m_giveupGroup = (GGroup)GetChildAt(31);
