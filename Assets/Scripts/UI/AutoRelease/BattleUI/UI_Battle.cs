...
namespace BattleUI
{
    public partial class UI_Battle : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            m_costBar = (GProgressBar)GetChildAt(13);
            m_left = (UI_BattleLeft)GetChildAt(14);
            m_DirectionBack = (UI_HuiZhao)GetChildAt(15);
            m_DirectonCancal = (GComponent)GetChildAt(16);
            m_DirectionPanel = (UI_SetPanel)GetChildAt(17);
            m_SkillUseBack = (GComponent)GetChildAt(18);
            m_SkillUsePanel = (UI_SkillUsePanel)GetChildAt(19);
            m_endClick = (GComponent)GetChildAt(21);
            m_endPic = (GLoader)GetChildAt(22);
